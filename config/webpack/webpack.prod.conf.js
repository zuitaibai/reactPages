...
let config = merge(baseWebpackConfig, {
    ...
    output: {
        ...
        filename: webpackFile.resource+'/js/[name].[chunkhash:8].js',
        chunkFilename: webpackFile.resource+"/js/[name]-[id].[chunkhash:8].js",
    },
    optimization: {
        //包清单
        runtimeChunk: {
    ...
    plugins: [
        ...
        new ExtractTextPlugin(webpackFile.resource+'/css/[name].[md5:contenthash:hex:8].css'),
        ...
        rules: [
            {
                test: /\.(js|jsx)$/,
                loader: 'babel-loader',
                exclude: /node_modules|runDist.js/,
            },
            {
                test: /\.(css|pcss)$/,
            ...
            },
            {
                ...
                loader: 'url-loader?limit=8192&name=[name].[hash:8].[ext]&publicPath=' + webpackFile.imgPrefix + '&outputPath=' + webpackFile.resource + '/img/'
            },
            {
                test: /\.swf$/,
...
config.plugins.push(new CopyWebpackPlugin([
    ...
    {from: './app/public/favicon.ico', to: './'},//网站favicon.ico
